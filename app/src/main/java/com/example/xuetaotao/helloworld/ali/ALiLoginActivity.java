...
public class ALiLoginActivity extends AppCompatActivity {
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        Toast.makeText(ALiLoginActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                    } else {
                        // 该笔订单真实的支付结果，需要依赖服务端的异步通知。
                        Toast.makeText(ALiLoginActivity.this, "支付失败", Toast.LENGTH_SHORT).show();
                    }
                    break;
                }
                case SDK_AUTH_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000") && TextUtils.equals(authResult.getResultCode(), "200")) {
                        ...
                        // 传入，则支付账户为该授权账户
                        Toast.makeText(ALiLoginActivity.this,
    ...
    public void payV2(View v) {
        ...
        Runnable payRunnable = new Runnable() {
            ...
            @Override
            public void run() {
                PayTask alipay = new PayTask(ALiLoginActivity.this);
    ...
    public void authV2(View v) {
        ...
        Runnable authRunnable = new Runnable() {
            ...
            public void run() {
                // 构造AuthTask 对象
                AuthTask authTask = new AuthTask(ALiLoginActivity.this);
                // 调用授权接口，获取授权结果
